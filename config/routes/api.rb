...
get 'get-filtered-cars', to:'user#get_filtered_cars', as: 'get_filtered_cars'
...
get 'ws-get-seller-profiles', to: 'user#ws_get_seller_profiles', as: 'ws_get_seller_profiles'